...
defaut reste interdit tant que les interactions essentielles et le comportement
Linux/macOS ne sont pas mesures, et que les gates de non-regression ne sont pas
passees.

## Documentation

- [`docs/research-map.md`](research-map.md): decision register et architecture de reference
- [`docs/m5-compatibility-release-hardening-report.md`](m5-compatibility-release-hardening-report.md): cloture historique M5
- [`docs/m4-public-proof-report.md`](m4-public-proof-report.md): preuve publique M4
- [`docs/reference-inventory/`](reference-inventory/): inventaires par engine
